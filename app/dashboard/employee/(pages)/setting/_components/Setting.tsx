...
const Setting: React.FC<SettingProps> = ({ user }) => {
  ...
  useEffect(() => {
    const fetchUserDetails = async () => {
      ...
      try {
        const response = await axios.get(`${API}/employee/setting/personal/${user.email}`);
  ...
  const handleUpdateProfile = async () => {
    ...
    try {
      ...
      const response = await axios.patch(
        `${API}/employee/setting/personal/${user.email}`,
        {
          name: fullName,
          email,
          phoneNumber,
  ...
  const handlePasswordChange = async () => {
    ...
    try {
      const response = await axios.patch(
        `${API}/employee/setting/password/${user.email}`,
        {
          currentPassword,
          newPassword,
          confirmPassword,
