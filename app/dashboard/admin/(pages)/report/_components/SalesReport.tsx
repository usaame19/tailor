...
const SalesReports = () => {
    ...
    const handleCustomReport = () => {
        if (startDate && endDate) {
            ...
            router.push(`/dashboard/admin/report/generate?report=custom&from=${from}&to=${to}`);
        } else {
    ...
    return (
        <div className="max-w-4xl mx-auto mt-10 p-6 bg-white shadow rounded-lg">
            ...
            <div className="space-y-4">
                {/* Today */}
                <Link href="/dashboard/admin/report/generate?report=today"
                ...
                {/* Yesterday */}
                <Link href="/dashboard/admin/report/generate?report=yesterday"
                    className="block bg-gray-100 p-4 rounded-lg hover:bg-gray-200 transition">
                ...
                {/* This Week */}
                <Link href="/dashboard/admin/report/generate?report=this-week"
                    className="block bg-gray-100 p-4 rounded-lg hover:bg-gray-200 transition">
                ...
                {/* This Month */}
                <Link href="/dashboard/admin/report/generate?report=this-month"
                    className="block bg-gray-100 p-4 rounded-lg hover:bg-gray-200 transition">
                ...
                {/* This Year */}
                <Link href="/dashboard/admin/report/generate?report=this-year"
                    className="block bg-gray-100 p-4 rounded-lg hover:bg-gray-200 transition">
